...
class App extends Component {
  ...
  constructor(props) {
    ...
    // bind 'this' to the App Class not the component defined on.
  ...
  // Event on the search input when it's text changes
...
// Search refactored as a functional stateless component
  ...
  const sortClass = classNames(
    ...
    return (
      <Button onClick={() => onSort(sortKey)} 
              className={sortClass} type="button">
          {children}
      </Button>
    );
}
